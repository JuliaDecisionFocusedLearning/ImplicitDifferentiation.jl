...
The `mode` argument is an object from [ADTypes.jl](https://github.com/SciML/ADTypes.jl) that specifies whether the preparation should target `ForwardMode`, `ReverseMode` or both (`ForwardOrReverseMode`).
